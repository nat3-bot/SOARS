...
<center>
    ...
    <main>
        ...
        <form action="/student/organization_save/{{$org->id}}" method="POST" enctype="multipart/form-data" style="text-align:start;">
            @csrf
            ...
            <label for="OrganizationType" style="display:none;"><h2>First Select Organization Type</h2></label>
             <select id="type_of_organization" name="type_of_organization" style="display:none;" onchange="showHideOthers(this);" required>
             ...
             <label for="AcademicCourseBased" style="display:none;"><h2>Select, if Org is based on Academic Course</h2></label><br>
             <select id="academic_course_based" name="academic_course_based" onchange="showHideOthers(this);" style="display:none;" required>
            ...
            <label for="advisersInfoText">
                <h2 style="display:none;">Edit Advisers and Officers Information:</h2>
            </label>
            <div class="container">
            ...
            <div id="listOfOfficersContent" class="card mt-4 mb-4" style="height: auto; text-align:start; display:none;"">
